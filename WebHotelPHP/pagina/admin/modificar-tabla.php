			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fa fa-table"></i> Modificar Usuarios</div>
					<div class="card-body">
											...
											while($reg = mysqli_fetch_assoc($resul)){
												...
												if (strtolower($reg["usuario"]) != "admin"){
													echo '<tr>
															...
															<td>'.$reg["password"].'</td>
															<td>
															<button class="eliminar" type="submit" value="Modificar" name="'.$reg["usuario"].'"><img src="img/modificar.png" width="30" height="30"></button>
															</td>
															</tr>';
												}
											}
